...
let _write =
  funptr (ptr c_t @-> string @-> size_t @-> returning int64_t) -: "write"

let _writev =
  funptr (ptr c_t @-> ptr void @-> int @-> returning int64_t) -: "writev"

let _write_request =
  funptr (ptr c_t @-> ptr void @-> ptr uint64_t @-> returning int64_t)
  -: "write_request"

let _read =
  funptr (ptr c_t @-> ptr char @-> size_t @-> returning int64_t) -: "read"
...
let _set_string =
  foreign "tnt_set" (ptr c_t @-> int @-> string @-> returning int)
